		...
		<content class="container" role="main">
            ...
            <div class="row ">
                ...
                <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 panel">
                    ...
                    <legend class="color-blue">Liste des utilisateurs : <a  class="mini" href="https://bastienmarais.github.io/Daily-Print-Project/" target="_blank"> Besoin d'aide ? </a></legend>
						...
						<table class="table table-hover table-bordered table-responsive">
							<thead>
								<tr class="background-black">
									...
									<th scope="col" class="center col-xs-2 col-sm-2 col-md-2 col-lg-1">Supprimer</th>
								</tr>
							</thead>
							<?php 	
