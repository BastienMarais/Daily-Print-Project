...
$resultatINFO = new_request_graphe("INFO");
$dataINFOy=array($resultatINFO);
$resultatMMI = new_request_graphe("MMI");
$dataMMIy=array($resultatMMI);
$resultatGEII = new_request_graphe("GEII");
$dataGEIIy=array($resultatGEII);
$resultatReprographie = new_request_graphe("Reprographie");
$dataRecherchey=array($resultatReprographie);
$resultatRecherche = new_request_graphe("Recherche");
$dataReprographiey=array($resultatRecherche);
$resultatAutre = new_request_graphe("Autre");
