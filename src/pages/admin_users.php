					...
					<table class="table table-hover table-bordered table-responsive">
						...
						<tbody class="center">
							<tr id="1">
								...
								<td>
									<form>
										<input type="submit" id="sup1" value="Supprimer" class="btn background-gradient-4"/>
									</form>
								</td>
							</tr>
							<tr id="2">
								...
								<td>
									<form>
										<input type="submit" id="sup2" value="Supprimer" class="btn background-gradient-4"/>
									</form>
								</td>
							</tr>
							<tr id="3">
								...
								<td>
									<form>
										<input type="submit"id="sup3"  value="Supprimer" class="btn background-gradient-4"/>
									</form>
								</td>
							</tr>
							<tr id="4">
								...
								<td>
									<form>
										<input type="submit"  id="sup4" value="Supprimer" class="btn background-gradient-4"/>
									</form>
								</td>
							</tr>
						</tbody>
